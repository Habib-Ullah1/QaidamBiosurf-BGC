#!/bin/bash
#SBATCH --job-name=phase10_H6
#SBATCH --time=48:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --output=/data/habib/metagenome/biosurfactant/logs/phase10_H6_%j.log

source ~/miniconda3/etc/profile.d/conda.sh
conda activate checkm2_env

s=H6
BINS=/data/habib/metagenome/biosurfactant/H6/09_binning/metawrap_refined/metawrap_50_10_bins
OUTDIR=/data/habib/metagenome/biosurfactant/H6/10_checkm2
DB=/data/habib/metagenome/biosurfactant/databases/checkm2/CheckM2_database/uniref100.KO.1.dmnd

echo "=== Phase 10 CheckM2: H6 ==="
echo "Started: $(date)"
mkdir -p $OUTDIR
...
checkm2 predict \
  ...
  --extension fa \
  --threads 16 \
  2> /data/habib/metagenome/biosurfactant/logs/checkm2_H6.log
