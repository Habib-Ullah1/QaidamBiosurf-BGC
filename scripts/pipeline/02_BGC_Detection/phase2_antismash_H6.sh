#!/bin/bash
#SBATCH --job-name=antismash_H6
#SBATCH --time=99:99:99
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --output=/data/habib/metagenome/biosurfactant/logs/phase2_antismash_H6_%j.log
...
# Verify
head -5 $PROJECT/biosurfactant/scripts/phase2_antismash_H6.sh
