#!/bin/bash
#SBATCH --job-name=phase9d_C6
#SBATCH --time=99:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=120G
#SBATCH --output=/data/habib/metagenome/biosurfactant/logs/phase9d_C6_%j.log
...
echo "=== Phase 9d MetaWRAP bin refinement: C6 ==="
echo "Started: $(date)"
