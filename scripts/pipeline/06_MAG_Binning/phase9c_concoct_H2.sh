#!/bin/bash
#SBATCH --job-name=phase9c_H2
#SBATCH --time=99:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=120G
#SBATCH --output=/data/habib/metagenome/biosurfactant/logs/phase9c_H2_%j.log
...
BAM=/data/habib/metagenome/biosurfactant/H2/09_binning/bam/H2_sorted.bam
BINDIR=/data/habib/metagenome/biosurfactant/H2/09_binning
LOGDIR=/data/habib/metagenome/biosurfactant/logs

echo "=== Phase 9c CONCOCT: H2 ==="
echo "Started: $(date)"
...
concoct_coverage_table.py \
  ...
  $BAM \
  > $BINDIR/concoct/cut/H2_coverage_table.tsv
