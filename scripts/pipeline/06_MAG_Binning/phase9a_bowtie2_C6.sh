#!/bin/bash
#SBATCH --job-name=phase9a_C6
#SBATCH --time=99:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --output=/data/habib/metagenome/biosurfactant/logs/phase9a_C6_%j.log
...
R1=/data/habib/metagenome/analysis/MEDUSA/sample_C6/Pipeline/data/trimmed/C6.R1_trim.fastq
R2=/data/habib/metagenome/analysis/MEDUSA/sample_C6/Pipeline/data/trimmed/C6.R2_trim.fastq
OUTDIR=/data/habib/metagenome/biosurfactant/C6/09_binning
LOGDIR=/data/habib/metagenome/biosurfactant/logs

echo "=== Phase 9a Bowtie2: C6 ==="
echo "Started: $(date)"
