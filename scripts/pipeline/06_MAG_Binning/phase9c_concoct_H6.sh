#!/bin/bash
#SBATCH --job-name=phase9c_H6
#SBATCH --time=99:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=120G
#SBATCH --output=/data/habib/metagenome/biosurfactant/logs/phase9c_H6_%j.log
...
concoct_coverage_table.py \
  ...
  $BAM \
  > $BINDIR/concoct/cut/H6_coverage_table.tsv
