#!/bin/bash
#SBATCH --job-name=phase10_H2
#SBATCH --time=48:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --output=/data/habib/metagenome/biosurfactant/logs/phase10_H2_%j.log
...
checkm2 predict \
  ...
  --extension fa \
  --threads 16 \
  2> /data/habib/metagenome/biosurfactant/logs/checkm2_H2.log
